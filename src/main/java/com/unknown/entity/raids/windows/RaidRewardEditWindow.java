...
public class RaidRewardEditWindow extends Window
{
    ...
    public void printInfo()
    {
        ...
        updateButton.
                addListener(new UpdateButtonClickListener(attendants, share, comment));
    ...
    private void updateReward(RaidReward reward, List<String> newAttendants, double newShares, String newComment)
    {
    ...
    private TextField charList()
    {
        ...
        for (RaidChar character : chars) {
            characters.setValue(characters.getValue().toString() + character.
                    getName() + "\n");
        }
        return characters;
    }
    ...
    private class UpdateButtonClickListener implements ClickListener
    {
        ...
        public void buttonClick(ClickEvent event)
        {
            final ImmutableList<String> attendantlist = splitCharsToArray(attendants.
                    getValue().toString());
            final double newShares = Double.parseDouble(share.getValue().toString());
            String newComment = comment.getValue().toString();
            List<String> invalidchars = RaidDB.
                    findInvalidCharacters(attendantlist);
